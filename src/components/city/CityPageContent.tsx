          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="max-w-md mx-auto mb-6">
              ...
              >
                ...
                <div className="relative bg-gradient-to-r from-primary to-accent rounded-2xl px-6 py-5 flex items-center justify-center gap-4 transition-transform group-hover:scale-[1.02] shadow-2xl">
