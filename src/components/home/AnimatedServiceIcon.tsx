...
export default function AnimatedServiceIcon({
  ...
  const iconMap: Record<string, JSX.Element> = {
    ...
    emergency: (
      <svg viewBox="0 0 60 60" className="w-full h-full" fill="none">
        ...
        >
          <path d="M30 20 L25 5 L35 5 Z" className="fill-accent" />
          <path d="M30 20 L45 15 L40 25 Z" className="fill-red-500" />
        </g>
  ...
  return (
    <div className="w-16 h-16 relative">
      ...
      <div className="relative p-2">{iconMap[type] || iconMap.pipe}</div>
    </div>
  );
}
