    ...
    <section ref={sectionRef} className="py-16 md:py-24 bg-white dark:bg-gray-900">
      <div className="container mx-auto px-4">
              ...
              <div className="flex flex-col gap-3 w-full md:w-auto">
                <div className="bg-white/10 backdrop-blur rounded-xl p-4 max-w-xs">
                  ...
                  <p className="text-sm text-white/90 mb-2">
                    "Der Preis wurde mir VORHER gesagt, nicht erst auf der Rechnung... Endlich ein Handwerker, der nicht nachverhandelt."
                  </p>
                  <p className="text-xs text-white/60">— Thomas M., Nürnberg-Südstadt</p>
                </div>
                <div className="bg-white/10 backdrop-blur rounded-xl p-4 max-w-xs">
                  <div className="flex items-center gap-1 mb-2">
                    {[1, 2, 3, 4, 5].map((star) => (
                  ...
                  <p className="text-sm text-white/90 mb-2">
                    "Der Techniker hat mir mit der Kamera gezeigt, wo das Problem liegt... So sollte es immer sein."
                  </p>
                  <p className="text-xs text-white/60">— Michael B., Erlangen</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="mt-12 flex flex-wrap justify-center gap-4">
          ...
          <div className="flex items-center gap-2 px-4 py-2 bg-gray-100 dark:bg-gray-800 rounded-full">
            <CheckCircle className="w-4 h-4 text-emerald-500" />
            <span className="text-sm font-medium text-gray-700 dark:text-gray-300">Etablierter Familienbetrieb</span>
          </div>
        </div>
      </div>
    </section>
