...
const CAMPAIGN_TEMPLATES = {
  rohrreinigung: {
    ...
    descriptions: [
      "Professionelle Rohrreinigung in {city}. 24/7 Notdienst, nachvollziehbare Abrechnung. Jetzt anrufen!",
      "Abfluss verstopft? Wir nennen die Anfahrtszeit ehrlich am Telefon. Keine versteckten Kosten. Rufen Sie jetzt an!",
      "Rohrreinigung mit moderner Technik und erfahrenen Technikern. Abrechnung nach tatsächlichem Aufwand.",
  ...
  notdienst: {
    ...
    descriptions: [
      ...
      "Rohr verstopft? Soforthilfe - Tag & Nacht, 365 Tage im Jahr. Fachgerechte und saubere Ausführung.",
    ],
  },
  kanalreinigung: {
    keywords: [
    ...
    headlines: [
      ...
      "Faire Kanalreinigung",
      "Schnelle Kanalreinigung",
      "Kanal Verstopft?",
      "Erfahrene Fachleute",
    ],
    descriptions: [
      "Professionelle Kanalreinigung in {city}. Hochdruckreinigung & TV-Inspektion. Faire Abrechnung nach Aufwand.",
