...
const faqCategories = [
  {
    ...
    questions: [
      ...
      },
      {
        ...
        answer: "Für die gesamte Amberg-Region berechnen wir pauschal 25€ Anfahrt – das sagen wir Ihnen am Telefon, bevor wir kommen.",
        shortAnswer: "25€ Anfahrtspauschale, immer vorher am Telefon kommuniziert."
      },
      {
    ...
    questions: [
      {
        ...
        answer: "In Amberg und der Region sind wir meist innerhalb von 70-100 Minuten bei Ihnen. Wir geben Ihnen am Telefon eine realistische Zeitangabe.",
    ...
    questions: [
      {
        ...
        answer: "Unser Kerngebiet: Amberg, Kümmersbruck, Ammerthal. Wir fahren auch ins Umland: Sulzbach-Rosenberg, Hahnbach, Vilseck, Hirschau, Neumarkt in der Oberpfalz und weitere Orte in der Oberpfalz (ca. 60 km Radius um Amberg).",
        shortAnswer: "Kerngebiet: Amberg, Kümmersbruck, Ammerthal. Plus Umland im 60-km-Radius."
      },
      {
        question: "Wo ist Ihr Firmensitz?",
        answer: "Unser Firmensitz ist in der Ehemannstraße 9, 90478 Nürnberg-Glockenhof. Von dort aus bedienen wir auch Amberg und die Oberpfalz – ein echter Familienbetrieb, kein Call-Center, keine Franchise.",
        shortAnswer: "Ehemannstr. 9, 90478 Nürnberg-Glockenhof. Familienbetrieb, bedient auch die Amberg-Region."
      },
      {
        question: "Wie lange gibt es Rohrreinigung Kraft schon?",
        answer: "Gegründet 2014 in Nürnberg. Über 10 Jahre Handwerks-Erfahrung, mehr als 2.000 erfolgreiche Einsätze – jetzt auch für Amberg und die Oberpfalz.",
