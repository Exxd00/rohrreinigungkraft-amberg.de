...
const createService = (
  ...
  longDescription:
    longDescription ||
    `${shortDescription} Professionelle Durchführung mit modernster Technik. Schnelle Anfahrt und faire Preise. 24/7 Notdienst verfügbar.`,
  features,
  icon,
});
...
export const services: Service[] = [
  ...
  createService(
    ...
    [
      "Spezialreinigung für Gussrohre",
      "Rostentfernung",
      "Ablagerungsbeseitigung",
      "Kamerainspektion",
      "Sanierungsberatung",
    ],
    "castiron",
