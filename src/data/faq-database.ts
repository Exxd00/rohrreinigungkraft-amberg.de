...
export const kostenFAQ: FAQItem[] = [
  ...
  },
  {
    ...
    shortAnswer: "In der gesamten Amberg-Region: 25€ Anfahrtspauschale, vorab am Telefon genannt.",
    fullAnswer: "Da unser Fachbetrieb nicht direkt vor Ort in Amberg sitzt, berechnen wir für die Anfahrt in die Region eine Pauschale von 25€ – das sagen wir Ihnen aber bereits am Telefon, bevor wir losfahren. Keine versteckten Kosten.",
    category: "kosten",
    page: ["preise", "faq"],
...
export const ablaufFAQ: FAQItem[] = [
  {
    ...
    shortAnswer: "Anruf → Wir kommen (70-100 Min) → Kostenlose Diagnose → Festpreis nennen → Ihr OK → Arbeit → Fertig.",
    fullAnswer: "1. Sie rufen an und schildern das Problem. 2. Wir kommen, meist innerhalb von 70-100 Min. 3. Vor Ort schauen wir uns das Problem an (kostenlos). 4. Wir erklären, was zu tun ist und nennen den Festpreis. 5. Sie entscheiden. 6. Bei OK arbeiten wir und hinterlassen alles sauber. 7. Sie zahlen, wir gehen.",
    category: "ablauf",
    page: ["homepage", "faq"],
  ...
  },
  {
    ...
    fullAnswer: "Wir sind ehrlich zu Ihnen: Da wir nicht direkt vor Ort sitzen, sind wir in Amberg und der näheren Umgebung meist in 70-100 Minuten vor Ort – das sagen wir Ihnen bereits am Telefon. Auch nachts und am Wochenende – unser 24/7 Notdienst ist immer einsatzbereit.",
    category: "ablauf",
...
export const notfallFAQ: FAQItem[] = [
  {
    ...
    fullAnswer: "Bei überlaufender Toilette: Sofort aufhören zu spülen! Wenn möglich, drehen Sie den Eckventil an der Toilette oder den Hauptwasserhahn zu. Legen Sie Handtücher aus, um Wasserschäden zu minimieren. Rufen Sie uns an – wir nennen Ihnen die Anfahrtszeit ehrlich am Telefon.",
    category: "notfall",
  ...
  },
  {
    ...
    shortAnswer: "In Amberg und Umgebung meist in 70-100 Minuten.",
    fullAnswer: "Wir sind ehrlich zu Ihnen: Die Anfahrt nach Amberg und in die Region dauert meist 70-100 Minuten. Wir sagen Ihnen am Telefon eine realistische Zeit – keine falschen Versprechen, auch nicht im Notfall.",
    category: "notfall",
...
export const b2bFAQ: FAQItem[] = [
  {
    ...
    fullAnswer: "Für Hausverwaltungen ab 5 Objekten bieten wir Rahmenverträge: 10% Rabatt auf alle Einsätze, Prioritäts-Notdienst (bevorzugte Einsatzplanung), persönlicher Ansprechpartner, monatliche Sammelrechnung, kostenlose jährliche Inspektion pro Objekt. Keine Mindestvertragsdauer.",
    category: "b2b",
  ...
  },
  {
    ...
    shortAnswer: "Prioritäts-Service: bevorzugte Einsatzplanung für Vertragskunden, Anfahrtszeit ehrlich am Telefon.",
    fullAnswer: "Geschäftskunden mit Rahmen- oder Wartungsvertrag erhalten Prioritäts-Service: bevorzugte Einsatzplanung, auch bei hoher Auslastung. Ihre Notfälle werden zuerst eingeplant, die realistische Anfahrtszeit nennen wir Ihnen ehrlich am Telefon.",
    category: "b2b",
    page: ["hausverwaltung", "faq"],
...
export const regionFAQ: FAQItem[] = [
  {
    ...
    shortAnswer: "Amberg, Kümmersbruck, Sulzbach-Rosenberg und die ganze Oberpfalz-Region – ca. 60 km Umkreis.",
    fullAnswer: "Wir sind in der Amberg-Region tätig: Amberg, Kümmersbruck und Ammerthal sind unser Kerngebiet. Außerdem: Sulzbach-Rosenberg, Hahnbach, Vilseck, Hirschau, Neumarkt in der Oberpfalz, Schwandorf und alle Orte im Umkreis von ca. 60 km um Amberg.",
    category: "region",
    page: ["homepage", "faq"],
  ...
  },
  {
    ...
    shortAnswer: "Unser Fachbetrieb ist in Nürnberg-Glockenhof registriert und bedient von dort aus auch die Amberg-Region.",
    fullAnswer: "Unser Firmensitz ist Ehemannstr. 9, 90478 Nürnberg-Glockenhof. Von dort aus bedienen wir auch Amberg und die Oberpfalz-Region – die Anfahrtszeit sagen wir Ihnen ehrlich am Telefon, damit Sie wissen, woran Sie sind.",
    category: "region",
  ...
  },
  {
    ...
    shortAnswer: "Meist in 70-100 Minuten. Kümmersbruck liegt direkt neben Amberg.",
    fullAnswer: "Kümmersbruck erreichen wir mit der gleichen Anfahrtszeit wie Amberg selbst – meist 70-100 Minuten. Wir sagen Ihnen die voraussichtliche Ankunftszeit bereits am Telefon, bei gutem Verkehr auch schneller.",
    category: "region",
  ...
  },
  {
    ...
    fullAnswer: "Sulzbach-Rosenberg gehört zu unserem erweiterten Servicegebiet: Anfahrt meist in 80-110 Minuten, plus 25€ Anfahrtspauschale. Wir kennen die Stadt gut – von der historischen Altstadt bis zu den Gewerbegebieten in Rosenberg.",
    category: "region",
    page: ["city-sulzbach-rosenberg", "faq"],
    keywords: ["sulzbach-rosenberg anfahrt", "rohrreinigung sulzbach-rosenberg"],
    priority: "medium",
    schema: true
  },
  {
    ...
    shortAnswer: "Nein, gleiche 25€ Anfahrtspauschale wie in der gesamten Region.",
    fullAnswer: "Für Neumarkt in der Oberpfalz und alle anderen Orte in unserem Servicegebiet berechnen wir die gleiche Anfahrtspauschale von 25€. Das sagen wir Ihnen bereits am Telefon, bevor wir losfahren – keine Überraschungen.",
    category: "region",
    page: ["faq"],
  ...
  },
  {
    ...
    fullAnswer: "Ja, wir kommen auch nach Regensburg und Umgebung – das liegt am Rand unseres ca. 60 km Servicegebiets. Anfahrtspauschale: 25€ (vorab am Telefon genannt). Anfahrtszeit: ca. 110-140 Minuten. Für dringende Fälle sind wir auch dort einsatzbereit.",
    category: "region",
    page: ["faq"],
  ...
  },
  {
    ...
    fullAnswer: "Altbauten in der Amberger Altstadt und den umliegenden historischen Ortskernen haben oft spezielle Herausforderungen: Gussrohre, alte Abzweigungen, gewachsene Strukturen. Mit über 10 Jahren Erfahrung kennen wir diese Probleme und wissen, wie man sie löst – schonend und effektiv.",
    category: "region",
    page: ["city-amberg", "faq"],
